...
const Header = ({ toggleSidebar }) => {
    return (
        <header className=' bg-white py-2 px-7 text-gray-600'>
            <div className=' flex justify-between items-center'>

                <div className='container flex items-center justify-start gap-6 '>
                    <a href="#" className='text-3xl lg:text-4xl font-bold text-purple-800 py-4 pr-10'>
                ...
                <div className="container flex items-center justify-between px-2 lg:px-4">
                ...
                <nav className="hidden md:flex flex-1 justify-between items-center space-x-4 lg:space-x-8">
